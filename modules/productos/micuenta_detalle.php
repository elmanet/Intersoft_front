...
<span style="font-size:40px;vertical-align: middle;">Detalle del Pedido #<?php echo $_GET['id_compra'];?></span> </p>
...
<a href="index.php?mg=mi-cuenta" style="float:right;margin-top:20px;margin-right:20px;">
